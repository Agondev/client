...
class _EditProjectState extends State<EditProject> {
  ...
  Widget teamMember() {
    return Container(
        child: Row(
      children: [
        Text("0xfawd8978ywev987aha8ahbewvhabfshadbvie",
                    ...
                    children: [
                      ...
                      Column(children: [
                        Container(
                            ...
                            width: 480,
                            child: Text(
                                "The dev/founding team can be allocated a maximum of 7% of the revenue generated by the mature agent, and that can be split between any number of Autonet contracts.")),
                        Container(
                            child: Column(children: [
                          Text("Distribution of revenue among founding team:"),
                          Column(
                            children: [teamMember()],
                          )
                        ]))
